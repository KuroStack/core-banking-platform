...
<div class="card card-warning">
    ...
    <form action="{{ route('superadmin.users.update', $user) }}" method="POST" data-validate>
        @csrf @method('PUT')
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    ...
                    <input type="checkbox" name="is_active" value="1" class="custom-control-input" id="is_active" {{ old('is_active', $user->is_active) ? 'checked' : '' }}>
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('superadmin.users.index') }}" class="btn btn-default">Cancel</a>
        </div>
    </form>
</div>
@endsection
