    ...
    <form action="{{ route('superadmin.fd-setups.update', $fdSetup) }}" method="POST" data-validate>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="duration_days" class="form-control @error('duration_days') is-invalid @enderror" value="{{ old('duration_days', $fdSetup->duration_days) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-2">
                            <div class="custom-control custom-checkbox d-inline mr-3">
                                ...
                                <input type="checkbox" name="is_senior_citizen" value="1" class="custom-control-input" id="is_senior_citizen" {{ old('is_senior_citizen', $fdSetup->is_senior_citizen) ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-checkbox d-inline">
                                ...
                                <input type="checkbox" name="is_special_roi" value="1" class="custom-control-input" id="is_special_roi" {{ old('is_special_roi', $fdSetup->is_special_roi) ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="2" required>{{ old('description', $fdSetup->description) }}</textarea>
